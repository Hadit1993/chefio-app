...
const TextField = forwardRef<TextInput, TextInputProps & TextFieldProps>((props, ref) => {
  ...
  const borderColor = useMemo(() => (props.isInvalid ? 'red' : isFocused ? AppTheme.colors.Primary : AppTheme.colors.Outline), [isFocused, props.isInvalid])
  const tintColor = useMemo(() => (props.isInvalid ? 'red' : isFocused ? AppTheme.colors.Primary : undefined), [isFocused, props.error])
