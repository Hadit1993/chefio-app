...
const TextField = forwardRef<TextInput, TextInputProps & TextFieldProps>(
  (props, ref) => {
    ...
    const borderColor = useMemo(
      () =>
        props.isInvalid
          ? "red"
          : isFocused && !props.disableFocusEffect
          ? AppTheme.colors.Primary
          : AppTheme.colors.Outline,
      [isFocused, props.isInvalid]
    );
    ...
    return (
      <>
        ...
        >
          ...
          />
          {props.rightIcon && (
            <TouchableWithoutFeedback onPress={props.rightIconOnPress}>
